...
const Navbar = ({ handleOrderPopup }) => {
  return (
    <div className="shadow-md bg-white dark:bg-slate-800 dark:text-white duration-200 relative z-40  sticky">
      ...
      <div data-aos="zoom-in" className="flex justify-center">
        <ul className="sm:flex hidden items-center gap-4">
          ...
          {/* <li className="group relative cursor-pointer">
            <a href="/women" className="flex items-center gap-[2px] py-2">
              Trending Products
              <span>
